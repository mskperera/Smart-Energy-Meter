...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
      ...
      <GiHamburgerMenu color='#fff' fontSize={27} className='hammenu' onClick={() => setToggleMenu(true)} />
      ...
      <div className='app__navbar-smallscreen_overlay flex__center slide-bottom'>
        ...
        <ul className='app__navbar-smaillscreen-links'>
          ...
          <li> <a href='/profile'><CgProfile color='black' size={30}/> Profile</a></li>
          <li> <a href='/'><MdLogout size={30} color='black'/>Logout</a></li>
        </ul>
      </div>
      )}
