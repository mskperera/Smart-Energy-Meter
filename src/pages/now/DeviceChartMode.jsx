...
import KwhBillChartMode from "./KwhBillChartMode";
import OperationalChartMode from "./OperationalChartMode";
...
function DeviceChartMode({ deviceName, device }) {
  ...
  return (
    <>
      <div className="section section-mode">
        <div className="section-status section-status-mode">
        ...
        {device.deviceTypeId === 2 && (
          <div className="line-values" style={{ display: 'flex'}}>
            <div className="line-type" title="Individual Line Measurement Mode" style={{cursor:'pointer', marginBottom:'5px'}}>
