...
const CustomCostAdmin = ({selectedDevice,startDate,endDate,isSearchLoading}) => {
 ...
 return <Bar data={data} options={options} className='chartadmin' id='boxadmin'/>
}
export default CustomCostAdmin